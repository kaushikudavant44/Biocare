...
<!-- Carousel================================================== -->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item active"> <img class="first-slide" src="${pageContext.request.contextPath}/resources/images/lab-banner.jpg" alt="health care"></div>
   </div>
<!-- /.carousel --> 
</div>
...
<!--signup over-->
<div class="clearfix"></div>
 <section class="lab_testsec">
	<div class="container">
	 <form action="/action_page.php">
      <input type="text" placeholder="Search for Tests and Lab.." name="search">
      <button type="submit"><i class="fa fa-search"></i></button>
    </form>
	 <img src="${pageContext.request.contextPath}/resources/images/search.jpg" class="img-responsive" alt="search lab"> 
		<h2>Finding the right lab made easy</h2>
		 <ul class="list_doc">
					<li>Search from a wide network of renowned labs</li>
					<li>Book tests and scans based on preferred cost, time, location and more</li>
					<li>Get detailed information including procedure, preparation, price range, and relevant labs near you</li>
		</ul>
		<hr>
		<!-- <h2>Tests</h2> -->
		<!-- <h4>Radiology test</h4>
		<ul class="radio_list">
			<a href="#"><li>MRI Scan</li></a>
			<a href="#"><li>CT Scan</li></a>
			<a href="#"><li>X-Ray Scan</li></a>
		</ul> -->
...
<c:otherwise>
	<a href="#" onclick="openLoginModal(3)"><h4>Find Right Lab</h4></a>
</c:otherwise>
