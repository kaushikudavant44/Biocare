...
<div class="clearfix"></div>
 <section class="lab_testsec producttab">
	<div class="container">
...
<!-- Carousel================================================== -->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active"> <img class="first-slide" src="${pageContext.request.contextPath}/resources/images/tablet-banner.jpg" alt="health care"></div>
   </div>
<!-- /.carousel --> 
</div>
...
<div class="productDetl">
	<div class="row">
		<div class="col-sm-4">
			...
			<h4 class="text-right wow fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1.5s">Exam Room Tablet</h4>
		</div>
