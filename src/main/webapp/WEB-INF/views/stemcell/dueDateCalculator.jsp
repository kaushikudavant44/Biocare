...
<html>
<head>
<title>Free Pregnancy Calculator </title>
...
<div class='clear'></div>
<form method="POST" action='${pageContext.request.contextPath}/submitPregnancyCalculator' id='tab' name=first class='frms'>
<div>
<div align='center'><label>Date of Last Menstrual Period:</label></div><br>
<div class="group_con">

<label class='leftt' required>Date 
<select name=len11>
<option name=1 value=1>1</option></label>
...
<div class="group_con">
<label class='leftt'>Months</label>
<select name=len12>
...
<option name=10 value=10>10</option>
<option name=11 value=11>11</option>
<option name=12 value=12>12</option></select>
</div></br>
<div class='group_con'>
<label class='leftt' required>Year</label>
...
<div align='center'><h5>Due Date, Firtility Date, Conception Date Calculator:</h5></div>
<label class='leftt'>Patients Fertility Dates :</label><br><br>
<span>
<input type=text readonly
class='tbox' name=fd1  style="width:20%">
</span>
<span class='new'>
to
</span>
<span><input type=text readonly
class='tbox' name=fd2 style="width:20%"> </span><div> <h1>Conception Calculator:</h1></br>
 <label class='leftt'>Patients Conception Date :</label>

<input type=text readonly name=cd style="width:40%"> </div><h1>Due Date Calculator</h1><div></br></br>
 <label class='leftt'>First Trimester Ends(12 Weeks) :</label></br>
<input type=text readonly name=fte style="width:40%"> </div>
<div> <label class='leftt'>Second Trimester Ends(27 Weeks):</label></br>
<input type=text readonly name=ste style="width:40%"> </div>
<div> <label class='leftt'>Patients Due Date(40 Weeks) :</label></br>
<input type=text readonly name=dd style="width:40%"> </div>

<!-- <label class='leftt'>name :</label>
<input type=text readonly name=patientName> </div> -->
</br></br>
