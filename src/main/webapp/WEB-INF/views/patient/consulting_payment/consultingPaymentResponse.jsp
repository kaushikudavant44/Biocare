...
<c:url var="submitConsultingPayment"
		value="/submitConsultingPayment" />
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					<div class="col-xs-6 col-sm-6 col-md-6 pad-0">
						<div class="receipt-right">
							<a class="exit_b" href="${pageContext.request.contextPath}/showPatientPaymentHistory">Exit</a>
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 pad-0">
						<div class="receipt-left">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showPatientPaymentHistorye">Try Again</a>
						</div>
					</div>
				</div>
            </div>
...
<div class="success-blk " id="successDiv" style="display: none">
 ...
 <h3 class="text-center">Thank You</h3>
	<p>Your Consulting Fees Submitted Successfully </p>
	<div class="row">
