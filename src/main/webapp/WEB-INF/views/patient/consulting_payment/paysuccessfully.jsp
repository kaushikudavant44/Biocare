...
<div class="login_screen"><img src="${pageContext.request.contextPath}/resources/images/login_bg.png" class="img-responsive" alt="login"></div>
    ...
    <h3 class="text-center">Thank You</h3>
   	<p>Your Registration Is Successful <br> Click Proceed To Go To The Home Screen</p>
   	 <%-- <img src="${pageContext.request.contextPath}/resources/images/payment-img.jpg" class="img-responsive" alt="logo">  --%>
   	<br>
