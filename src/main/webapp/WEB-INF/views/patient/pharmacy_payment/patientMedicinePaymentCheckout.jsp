...
<c:url var="submitPatientMedicinePayment" value="/submitPatientMedicinePayment" />
...
<div class="bhoechie-tab-content">
	...
	<!-- <pre></pre> -->
		<c:if test="${show==0}">
	<form method="post" action="${pageContext.request.contextPath}/patientMedicinePaymentGateway">
	...
	<h3 class="text-uppercase margn0">Pay with Wallet</h3>
		...
		<div class="prescptdiv">
			<div class="row">
				<div class="col-sm-6">
					<strong>Prescription Amount</strong>
				</div>
				<div class="col-sm-6 text-right">
					<input title="Prescription Amount" tabindex="10" type="text" id="prescriptionAmount" name="" value="${amount}" readonly>
				</div>
			</div>
		</div>
...
function paidByWallet(){
	...
	var prescriptionAmount=document.getElementById("prescriptionAmount").value;
	alert(prescriptionAmount);
	$.getJSON(
