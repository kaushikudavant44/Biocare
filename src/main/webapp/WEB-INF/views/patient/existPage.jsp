...
<section id="registration" class="log_sec">
	...
	<h4>Are You Existing User?</h4>
	<hr>
		<p class="text-center"><a href="${pageContext.request.contextPath}/showExistDetail" class="btn-fr-all">Yes</a>
		<a href="${pageContext.request.contextPath}/showPatientRegistrationPage" class="btn-fr-all">No</a></p>
        </div>
    </div>
</section>
