        	...
        	<jsp:include page="../include/patientLeftMenu.jsp"/>
				...
				<div
					...
					<div class="bhoechie-tab-content active">
						<form method="POST" action='${pageContext.request.contextPath}/submitPatientBankDetails'
							enctype="multipart/form-data" id="reset">
							<div class="row editpg">

								<input type="hidden" value="${patientBankAccountInfo.id}"
									name="id">
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Account Holder Name</label> <input
											...
											value="${patientBankAccountInfo.accHolderName}" name="accHolderName" id="accHolderName"
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Bank Name</label> <input
											...
											id="bankName" value="${patientBankAccountInfo.bankName}"
											onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 31 && event.charCode < 33)"
											data-rule-required="true" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Branch</label> <input
											...
											id="bankBranch" value="${patientBankAccountInfo.bankBranch}"
											data-rule-required="true" />
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Account Number</label> <input
											required type="text"
											value="${patientBankAccountInfo.accountNo}" class="input-text"
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">IFSC Code</label> <input
											...
											value="${patientBankAccountInfo.ifscCode}" name="ifscCode"
											id="ifscCode" >  
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">PAN No</label> <input required
											...
											value="${patientBankAccountInfo.panNo}" name="panNo" id="panNo" readonly>
								 ...
								 <div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">GSTIN</label> <input
											type="text" class="input-text" style="text-transform: uppercase;"
											value="${patientBankAccountInfo.gstNo}" name="gstNo" id="gstNo">
