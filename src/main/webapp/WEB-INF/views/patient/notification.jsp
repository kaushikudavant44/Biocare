		...
		<div class="bhoechie-tab-container">
			<div class="drop-content">
				<div class="row">
					...
					<c:forEach items="${patientNotificationList}"
						var="patientNotificationList">
						<c:choose>
						<c:when test="${patientNotificationList.status==0}">
						<div class="col-md-12 col-sm-12 col-xs-12 pd-l0 border-bottom unread-bg">
							<div class="all-notofication">
								...
								<p class="dr-icon">${patientNotificationList.string1}</p>
 								<p>${patientNotificationList.notification}.</p>
								<p class="date">${patientNotificationList.dateTime}"</p>
							</div>
						</div>
						</c:when>
						<c:otherwise>
