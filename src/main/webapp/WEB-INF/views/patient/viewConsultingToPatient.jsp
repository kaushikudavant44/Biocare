										...
										<div class="panel-heading reletive">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													...
													aria-hidden="true" id="popoverOption" rel="popover"
												...
												</a><a href="${pageContext.request.contextPath}/showConsultBill/${getConsultingDetailsByDoctor.meetId}"><span
													class="icon-newspaper mar-right" aria-hidden="true"
													id="popoverOption" rel="popover" data-placement="bottom"
...
function consultList(doc, i)
{
	...
	strVar += "									<a href=\"${pageContext.request.contextPath}/showConsultBill/"+meetId+"\"><span class=\"icon-newspaper mar-right\" aria-hidden=\"true\" id=\"popoverOption\" rel=\"popover\" data-placement=\"bottom\" data-original-title=\"Invoice\" \"> <i>Invoice<\/i><\/span><\/a>";
