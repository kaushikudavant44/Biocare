	...
	<div class="container">
	 <div class="login1_blk">
	 	...
	 	<p id="errormessage" style="color:red;position:absolute; margin: 0 auto; left:0; right:0" maxlength="20"></p>
	 		 	<p><small>Please check your email for a message with your code.</small></p>
	 	
	 	 <input type="hidden" name="email" id="email" value="${email}"> 
        <form action="submitVerificationCode" method="GET">
        ...
        <p class="timeoutmsg"><a href="#" onclick="resendCode()">Time Out Click on Resend OTP</a></p>
...
function resendCode() {
	 ...
	 var emailId=document.getElementById("email").value; 	
	   	...
	   	window.open("${pageContext.request.contextPath}/ShowVerifyForgetPassword?emailId="+emailId+"&userName="+userName,"_self");
