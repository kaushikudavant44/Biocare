...
<div class="dashboard_nm text-center"><h4>Edit Patient History </h4></div>
<div class="container-fluid">
  ...
  <form  action="${pageContext.request.contextPath}/updatePatientPersonalHistoryRegProcess" method="POST"> 
   ...
   <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        <textarea  name="Chief" >${patientHistoryChiefComplaints.complaints}</textarea>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
        ...
        <div class="cont_blk past_history">
         <c:forEach items="${patientHistoryIllnessList}" var="patientHistoryIllnessList" varStatus="count">
            ...
            <span class="input input--nao">
                          ...
                          <label><input type="checkbox" name="illness" checked="checked" value="${patientHistoryIllnessList.pastHistoryIllnessId}" >${patientHistoryIllnessList.illnessName}</label>
  ...
  <div class="panel panel-default">
    ...
    <input id='watch-me' name='test' type='radio'  value="a"  />Yes
   
    <input name='test' type='radio'  value="NO"  /> No

<div id='show-me' style='display:none'><textarea   name="Maritalstatus" >${patientPersonalHistory.maritalStatus}</textarea></div>                  
                            </div>
        ...
        <textarea  name="Occupation" >${patientPersonalHistory.occupation}</textarea>
         <hr>
         <strong>3. Income (asked indirectly) and social status</strong>
        <textarea  name="Income" >${patientPersonalHistory.anualIncome}</textarea>
        <hr>
        ...
        <textarea  name="Addiction" >${patientPersonalHistory.addiction}</textarea>
        <hr>
         <strong>5. Dietary habit(for diagnosis of avitaminosis, malnutrition, obesity)</strong>
        <textarea  name="Dietary" >${patientPersonalHistory.dietaryHabits}</textarea>
        <hr>
         <strong>6. History of Contraception</strong>
        <textarea  name="Contraception" >${patientPersonalHistory.historyOfConterception}</textarea>
        <hr>
        ...
        <textarea  name="HighRiskbehaviour" >${patientPersonalHistory.highRiskBehaviour}</textarea>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
      <div class="panel-body">
        ...
        <textarea  name="FamilyHistory" >${patientFamilyHistory.familyHistory}</textarea>
  ...
  <div class="panel panel-default">
    ...
    <%-- <textarea   name="Treatment" >${patientTreatementHistoryp.treatmentReceived}</textarea> --%>
    
    <div class="gender_sec" id='form-id'>
                            
    <input id='watch-me' name='test1' type='radio' value="a" />Yes
   
    <input name='test1' type='radio' value="NO"  /> No

<div id='show-me1' style='display:none'><textarea name="Treatment">${patientTreatementHistoryp.treatmentReceived}</textarea></div>
                            </div>
    ...
    <input id='watch-me' name="test2"  type='radio' value="a" />Yes
   
    <input name="test2"  type='radio' value="NO"  /> No

    <div id='show-me2' style='display:none'><textarea name="drugallergy">${patientTreatementHistoryp.allergyReactions}</textarea> </div>
                            </div>
    ...
    <input id='watch-me' name='test3' type='radio' value="a" />Yes
   
    <input name='test3' type='radio' value="NO"  /> No

<div id='show-me3' style='display:none'><textarea name="surgicalintervention"  >${patientTreatementHistoryp.surgicalIntervention}</textarea></div>
                            </div>
       ...
       <div class="gender_sec" id='form-id'>
       <input id='watch-me' name='test4' type='radio' value="a" />Yes
   
    <input name='test4' type='radio' value="NO"  /> No

<div id='show-me4' style='display:none'><textarea name="contraceptives">${patientTreatementHistoryp.useOralContraceptives}</textarea></div>
                            </div>
        ...
        <textarea  name="Bloodtransfusion" >${patientTreatementHistoryp.bloodTransfusion}</textarea>
      
        <div class="clearfix"></div>
        <hr>
         <strong>6. Intake of NSAID (may produce acute gastric erosion, NSAID-induced asthma etc.)</strong>
       
        <textarea  name="Intake" >${patientTreatementHistoryp.intakeNsaid}</textarea>
     
         <div class="clearfix"></div>
        <hr>
         <strong>7. Regular user of oral contraceptives, vitamins, laxatives, sedatives or herbal remedies.</strong>
       
        <textarea  name="contraceptives" >${patientTreatementHistoryp.regularUsezoralContraceptives}</textarea>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
      <div class="panel-body">
        <textarea  name="PsychologicalHistory" >${patientPsychologicalHistory.psychologicalHistory}</textarea>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
      <div class="panel-body">
       <strong>1.Menarche.</strong>
        <textarea  name="Menarche" >${menstrualObstetricHistory.menarche}</textarea>
        <hr>
         <strong>2.Duration of the period.</strong>
        <textarea  name="durationperoid" >${menstrualObstetricHistory.durationOfPeriod}</textarea>
        <hr>
         <strong>3.Quantity of blood loss(usually assessed by number of pads consumed or passage of clots).</strong>
        <textarea  name="bloodloss" >${menstrualObstetricHistory.qtyOfBloodLoss}</textarea>
        <hr>
         <strong>4.Dysmenorrhoea, amenorrhoea or other menstrual irregularities.</strong>
        <textarea  name="Dysmenorrhoea" >${menstrualObstetricHistory.menstrualErregularities}</textarea>
        <hr>
         <strong>5.Date of last menstrual period.</strong>
        <textarea class="datepicker"  name="menstrual" >${menstrualObstetricHistory.dateOfLastPeriod}</textarea>
        <hr>
         <strong>6.Menopause, post-menopausal bleeding.</strong>
        <textarea  name="Menopause" >${menstrualObstetricHistory.menopause}</textarea>
        <hr>
         <strong>7.Obstetric history: </strong>
         <div class="clearfix"></div>
         	<strong>a) No.of pregnancies</strong> 
             <textarea  name="pregnancies" >${menstrualObstetricHistory.noOfPregnancies}</textarea>
             <hr>
            <strong> b) Outcome of pregnancies : H/O abortions or carried to term:live birth (male/female)</strong>
             <textarea  name="Outcomepregnancies" >${menstrualObstetricHistory.outcomeOfPregnancies}</textarea>
              <hr>
             <strong>c) Complications during pregnancy (e.g hypertension, gestational diabetes mellitus)</strong> 
             <div class="cont_blk past_history">
              <div class="gender_sec" id='form-id'>
                            
    <input id='watch-me' name='test5' type='radio' value="a" />Yes
   
    <input name='test5' type='radio' value="NO"  /> No

<div id='show-me5' style='display:none'>  <textarea name="Complicationspregnancy"  >${menstrualObstetricHistory.complicationsDuringPregnancies}</textarea></div>
                            </div>
            ...
            <strong> d) Mode of delivery (Vaginal , foreeps, caesaream)</strong>
             <textarea  name="Modedelivery" >${menstrualObstetricHistory.made_of_delivery}</textarea>
              <hr>
            <strong> e) Last child birth</strong>
             <textarea class="datepicker"  name="Lastbirth" >${menstrualObstetricHistory.last_child_birth}</textarea>
