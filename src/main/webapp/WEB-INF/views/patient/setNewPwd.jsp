...
<c:url var="updtaePatientNewPassword" value="updtaePatientNewPassword" />
	...
	<div class="container">
	 <div class="login1_blk">
       ...
       <input type="hidden" id="userName" name="userName" value="${userName}">
        ...
        <input type="password" id="password" name="password" placeholder="Enter Password"  class="capitl_none" required>
        <p id="validate1" style="color:red;position:absolute"></p>
          </div>     
           <div class="form-group ">      
        <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirm Password "  class="capitl_none" required>
     
        <p style="position:absolute" id='message'></p>
        </div>
