...
<c:url var="sendTextOtp"
		...
		<c:url var="saveDoctorSignature"
		value="/saveDoctorSignature" />
...
<div class="container-fluid">
	<div class="row">
        <div class="bhoechie-tab-container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab doc_profile">
        	...
        	<input type="hidden" value="${doctorDetails.profilePhoto}" name="profilePhoto">
        		...
        		<div class="col-sm-4">
                	...
                	<div class="form-group">
            		 ...
            		 <input type="text" class="input-text" name="mName" id="mName" value="${doctorDetails.mName}" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 31 && event.charCode < 33)" data-rule-required="true" />
            		 </div>
					</div>
					<div class="col-sm-4">
                	<div class="form-group">
         ...
         <option value="Female">Female</option>
				...
				<div class="col-sm-4">
				 <div class="form-group">
				            	...
				            	<input required type="text"  class="input-text" value="${doctorDetails.contactNo}" name="contactNo" id="contactNo" onkeypress='return IsNumeric(event);' min="10" maxlength="13" readonly>
								<span id='contactMessage' style="position: absolute;color: red; line-height: 17px; font-size: 12px !important;"></span>
								 <i class="icon-checked verified" aria-hidden="true" id="verifiedMark" style="display:none; color:green"></i>
				</div>
				</div>
				<div class="col-sm-4">
				<div class="form-group">
          ...
          <option selected  value ="${countryList.countryId}">${countryList.countryName }</option>
				...
				<div class="form-group">
							 ...
							 <c:forEach items="${cityList}" var = "cityList">
									   <c:choose>
                                            <c:when test = "${cityList.cityId==doctorDetails.stateId}">
				...
				<c:set var="signStatus" value=""/>
				<c:choose>
				<c:when test="${doctorDetails.delStatus==2}">
				<c:set var="signStatus" value="disabled='disabled'"/>
				<%-- <input type="hidden" name="uploadCertificateStatus" value="${uploadCertificateStatus}"> --%>
				<div class="row">
				<div class="col-md-8 col-sm-8 ">
				<div class="col-md-4 col-sm-4 ">
				<label>Upload Certificate</label> 
				 <input type='file' id="fileChoose" name="certificatePhoto" class="choosefile" required /> 
				<a class="example-image-link"  id="myImg" href="#" alt="your image"  data-lightbox="example-set" data-title="Certificate"><strong>View Certificate</strong></a>
				<!-- <p> It May take 24 to 48hrs for verification process.</p> -->
				</div>
				<div class="col-md-8 col-sm-8 ">
			<!-- 	<label>Upload Signature </label>
				<input type='file' id="signaturePhoto" name="signaturePhoto" class="choosefile" required />
				<a class="example-image-link"  id="myImg" href="#" alt="your image"  data-lightbox="example-set" data-title="Certificate"><strong>View Signature</strong></a> -->
				<div id="wrapper">
			<label>Write Signature </label>
			<div id="canvas">
			...
			<img id="saveSignature" alt="Saved image png"/>
				...
				<button  type="button" onclick="zkSignature.send()">Save Signature</button>
              ...
              <!--  <input id="verifyButton" data-toggle="modal" data-target="#otp" type="button" value="Verify" class="btn-fr-all" onclick="verifyMobileNumber()"> --> 
                    	<input type="submit" ${signStatus} name="Submit" class="btn-fr-all" id="submitButton">
                    	<input type="reset" value="Cancel" class="btn-fr-all">
                </div>
                </div>
            </div>
        </form>       
