...
<c:url var="sendTextOtp" value="/sendTextOtp" />
  ...
  <c:url var="deleteClinicById"	value="/deleteClinicById" />

<div class="clearfix"></div>
<section class="doc_login">
	<div class="dashboard_nm text-center"><h4>Clinic List</h4></div>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab doc_profile">
                <div class="bhoechie-tab-content active">
					...
					<c:forEach items="${hospitalDetails}" var="hospitalDetails">
						...
						<td><a onclick="deleteClinic(${hospitalDetails.hospitalId})" name="hospitalId" href="#"><span class="icon-rubbish-bin"></span></a></td> 		
						</c:if>
						</c:forEach>
...
function deleteClinic(hospitalId){
