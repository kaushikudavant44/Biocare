        	...
        	<jsp:include page="../include/leftmenu.jsp"/>
				...
				<div
					...
					<div class="bhoechie-tab-content active">
						<form method="POST" action='${pageContext.request.contextPath}/submitDoctorBankDetails'
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Account Holder Name</label> <input
											...
											value="${doctorBankAccountInfo.accHolderName}" name="accHolderName" id="accHolderName"
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Bank Name</label> <input
											...
											id="bankName" value="${doctorBankAccountInfo.bankName}"
											onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 31 && event.charCode < 33)"
											data-rule-required="true" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Baranch</label> <input
											...
											id="bankBranch" value="${doctorBankAccountInfo.bankBranch}"
											data-rule-required="true" />
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Account Number</label> <input
											required type="text"
											value="${doctorBankAccountInfo.accountNo}" class="input-text"
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">IFSC Code</label> <input
											...
											value="${doctorBankAccountInfo.ifscCode}" name="ifscCode"
											id="ifscCode" >  
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">PAN No</label> <input required
											...
											value="${doctorBankAccountInfo.panNo}" name="panNo" id="panNo"  >
								 ...
								 <div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">GSTIN</label> <input required
											type="text" class="input-text" style="text-transform: uppercase;"
											value="${doctorBankAccountInfo.gstNo}" name="gstNo" id="gstNo">
