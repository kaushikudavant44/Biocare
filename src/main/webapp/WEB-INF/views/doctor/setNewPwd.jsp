...
<c:url var="updtaeDocotrNewPassword" value="updtaeDocotrNewPassword" />
	...
	<div class="container">
	 <div class="login1_blk">
        ...
        <input type="password" id="password" name="password" placeholder="Enter Password"  class="capitl_none" required><p id="validate1" style="color:red;position:absolute"></p>
             <span class="show-pass"><i class="icon-eye-with-a-diagonal-line-interface-symbol-for-invisibility" aria-hidden="true" onclick="myFunction()"></i></span>
          </div>  
