...
<script type="text/javascript">
  ...
  <c:url var="doctorPasswordValidation" value="doctorPasswordValidation" />
<c:url var="changeDoctorPassword" value="changeDoctorPassword" />	
 ...
 <section class="log_sec">
	...
	<div class="container">
	 <div class="login1_blk">
		...
		<a href="${pageContext.request.contextPath}/showDoctorHomePage">Cancel</a>
	 </div>
