...
<!-- Carousel================================================== -->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item active"> <img class="first-slide" src="${pageContext.request.contextPath}/resources/images/order-banner.jpg" alt="health care"></div>
   </div>
<!-- /.carousel --> 
</div>
...
<div class="clearfix"></div>
 <section class="lab_testsec">
	...
	<!--  <form action="/action_page.php">
      <input type="text" placeholder="Search for Medicines.." name="search">
      <button type="submit"><i class="fa fa-search"></i></button>
    </form> -->
	<%--  <img src="${pageContext.request.contextPath}/resources/images/medicine.jpg" class="img-responsive" alt="search lab">  --%>
	 <h2> Get every medicine</h2>
	
<p>When you purchase medicines on Biocare, you can be assured that you will get the medicines you order.
<br> Biocare has the widest range of medicines online, sourced from our trusted network of pharmacies and medical stores.</p>
<div class="space_btw"></div>
<c:choose>
<c:when test="${sessionScope.patientDetails.patientId>0}">
		<a href="${pageContext.request.contextPath}/showOrderMedicinePage" class="btn-fr-all">Order Now</a>
</c:when>

<c:otherwise>
		<a href="#" onclick="openLoginModal(4)" class="btn-fr-all">Order Now</a>
</c:otherwise>
