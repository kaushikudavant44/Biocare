        ...
        <div class="bhoechie-tab-container">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
	               <div class="bhoechie-tab-content active">
	                		  <c:forEach items="${getMedicalOrderDetailsList}" var="getMedicalOrderDetailsList"
									varStatus="count">
	                		<div class="pharmacy_ord">
	                			...
	                			<h3><a href="#" data-toggle="modal" data-target="#largeModal" onclick="getPrescriptionImage(${getMedicalOrderDetailsList.patientId},${getMedicalOrderDetailsList.requestToMedicalId},'${getMedicalOrderDetailsList.prescriptionName}')">
