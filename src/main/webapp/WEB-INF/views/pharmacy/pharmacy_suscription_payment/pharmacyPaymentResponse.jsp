...
<c:url var="savePharmacyDetailsAndPayment"
		value="/savePharmacyDetailsAndPayment" />
    ...
    <h3 class="text-center">Failed</h3>
   	<p>Sorry Pharmacy Payment Is Failed</p>
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center"> 
							<a class="proceed_b" href="${pageContext.request.contextPath}/showPharmacyLoginPage">Exit</a>
						</div>
					</div>
...
<div class="success-blk " id="successDiv" style="display: none">
 ...
 <h3 class="text-center">Thank You</h3>
        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
			...
			<div class="row">
				<div class="receipt-header receipt-header-mid receipt-footer">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showPharmacyHomePage">Proceed</a>
						</div>
					</div>
				</div>
            </div>
   	...
   	<div class="receipt-main col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
            ...
            <div>
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showPharmacyLoginPage">Proceed</a>
						</div>
					</div>
				</div>
            </div>
	...
	<%-- <%=outputHTML%> --%>
		...
		<a id="urlBtn" style="display: none" href="${pageContext.request.contextPath}/showPharmacyLoginPage">Go To Login</a>
