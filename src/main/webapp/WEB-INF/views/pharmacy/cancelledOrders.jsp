...
<div class="dashboard_nm text-center"><h4>Cancel Orders</h4></div>
	...
	<div class="row">
        <div class="bhoechie-tab-container">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
	             ...
	             <c:forEach items="${getMedicalOrderDetailsList}" var="getMedicalOrderDetails" varStatus="count">
	                  ...
	                  <c:forEach items="${getMedicalOrderDetailsList1}" var="getMedicalOrderDetails" varStatus="count">
	                		<div class="pharmacy_ord">
