                ...
                <div class="bhoechie-tab-content active">
                	<div class="col-sm-3">
	                	 <div class="dashbox">
	                	 	 ...
	                	 	 <p class="text-center">${orderDetails.orderCount}</p>
	                	 	 <div class="taskBlk">Total Orders</div>
	                	 </div>
                	 </div>
                	 <div class="col-sm-3">
	                	 <div class="dashbox">
	                	 	 <div class="dashCircle"><span class="icon-calendar-page"></span></div>
	                	 	 <p class="text-center">${orderDetails.delivered}</p>
	                	 	 <div class="taskBlk">Delivered Orders</div>
	                	 </div>
                	 </div>
                	 ...
                	 <div class="col-sm-3">
	                	 <div class="dashbox">
	                	 	 <div class="dashCircle"><span class="icon-calendar-page"></span></div>
	                	 	 <p class="text-center">${orderDetails.collection}</p>
