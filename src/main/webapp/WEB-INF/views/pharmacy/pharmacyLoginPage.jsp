...
<script type="text/javascript">
  ...
  <body onload="initialize()" class="login_prt"> 
  ...
  <c:url var="getCityByStateId" value="/getCityByStateId" />
  <c:url var="pharmacyLoginProcess" value="/pharmacyLoginProcess" />
...
<div class="clearfix"></div>
 <%-- <section class="log_sec">
	<div class="container">
	 <div class="login1_blk">
        ...
        <input type="text" class="capitl_none" id="LogInUname" name="userName" placeholder="Username"  required="required" onclick="clearMsg()">
       
             <div class="loader2" style="position: fixed;margin-left: 140px" id="loader"> </div>
       
        <input type="password" class="capitl_none" id="LogInPasswors" name="password" placeholder="Password" onkeypress="if(event.keyCode==13) {patientLogin();}"  required>
	 	<input type="submit" name="submit" value="LOGIN" class="btn-fr-all" onclick="patientLogin()">
	 	<a href="${pageContext.request.contextPath}/showPharmacyRegistrationPage">Sign Up</a><br>
 ...
 <div class="login_screen"><img src="${pageContext.request.contextPath}/resources/images/login_bg.png" class="img-responsive" alt="login"></div>
    ...
    <p id="errormessage" style="color:red;position:absolute; margin: 0 auto; text-align:center; left:0; right:0" maxlength="20">${msg}</p>
    	...
    	<p class="text-center"><input type="submit" class="submit_b"  onclick="patientLogin()" value="Login"></p>
        <p class="text-left"><a href="${pageContext.request.contextPath}/ShowPharmacyForgotPassword" class="link_anch"  > Forgot Password ?</a></p>
        <p class="text-right"><a href="${pageContext.request.contextPath}/showPharmacyRegistrationPage" class="link_anch"> Sign Up</a></p>
    </div>
		 ...
		 window.close();
																	...
																	if(userName==""||userName==null) 
																	 ...
																	 alert("Please enter username."); 
																		...
																		{
																		window.parent.close();
																		window.open("${pageContext.request.contextPath}/ShowPharmacyForgotPassword?userName="+userName,"_blank");
