...
<div id="largeModal" class="modal fade bs-example-modal-lg"
			...
			<div class="modal-dialog modal-md modal-sm" style="width:25%;margin-top:10%">
				<div class="modal-content">
				  <form action="${pageContext.request.contextPath}/checkPatientType" method="post">  
					<div class="modal-header">
						<!-- <button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button> -->
						<h4 class="modal-title"  align="center">Check User</h4>
					</div>
					<div class="modal-body">
				
						<input type="radio" name="patient" value="0" onclick="showPatientDetails(0)"> New Patient <br>
  						<input type="radio" name="patient" value="1" onclick="showPatientDetails(1)"> Existing on Bionische <br>
...
<%--  <script src="${pageContext.request.contextPath}/resources/js/custom.js"></script> --%>
 ...
 function showPatientDetails(patientType){
	 
	 if(patientType==0){
	 window.open("${pageContext.request.contextPath}/showNewPndtPatientRegistration/0",'_self');
 }else{
	 window.open("${pageContext.request.contextPath}/showPndtPage",'_self');
 }
 }
