...
<div class="clearfix"></div>
 <section class="lab_testsec producttab1 waitingRm">
	<div class="container-fluid">
		...
		<div class="row">
				<div class="col-sm-6 wow fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1s">
					<img src="${pageContext.request.contextPath}/resources/images/infusionPc.png" class="img-responsive" alt="Pc">
				</div>
				<div class="col-sm-6">
					<div class="city_sec wow fadeInRight" data-wow-delay="0.1s" data-wow-duration="1s">
		             ...
		             <div class="city_sec wow fadeInRight" data-wow-delay="0.1s" data-wow-duration="1.5s">
			             <div class="circle_sec">
			             	<span>vgth</span>
			             </div>
			             <h4>Lorem Ipsum is simply dummy text</h4>
		             ...
		             <div class="city_sec wow fadeInRight" data-wow-delay="0.1s" data-wow-duration="2s">
			             <div class="circle_sec">
			             	<span>vgth</span>
			             </div>
			             <h4>Lorem Ipsum is simply dummy text</h4>
...
<!-- Carousel================================================== -->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active"> <img class="first-slide" src="${pageContext.request.contextPath}/resources/images/infusion.jpg" alt="health care"></div>
   </div>
<!-- /.carousel --> 
</div>
...
<div class="productDetl">
	<div class="row">
		<div class="col-sm-4">
			...
			<h4 class="text-right wow fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1.5s">Infusion Room Tablet</h4>
		</div>
