...
<c:url var="submitDoctorSuscription"
		value="/submitDoctorSuscription" />
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					 <div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
							<a class="proceed_b" href="${pageContext.request.contextPath}/showDoctorLoginPage">Exit</a>
						</div>
					</div> 
					<%-- <div class="col-xs-6 col-sm-6 col-md-6 pad-0">
						<div class="xreceipt-left">
 ...
 <h3 class="text-center">Thank You</h3>
        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
			...
			<div class="row">
				<div class="receipt-header receipt-header-mid receipt-footer">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showFirstTimeUpdateDoctorProfile">Proceed</a>
						</div>
					</div>
				</div>
            </div>
   	...
   	<div class="receipt-main col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
            ...
            <div>
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showDoctorLoginPage">Proceed</a>
						</div>
					</div>
				</div>
            </div>
	...
	function submitData(txnId){
				...
				if(respCode==1)
					...
					/* document.getElemntById("txnid").value=txnId;
					document.getElemntById("txnid").value=orderId;
					document.getElemntById("txnid").value=bankname;
					document.getElemntById("txnid").value=gateway;
					document.getElemntById("txnid").value=MId;
					document.getElemntById("txnid").value=paymentmode;
					document.getElemntById("txnid").value=txnAmt;
					document.getElemntById("txnid").value=txnDate;
					document.getElemntById("txnid").value=SubAmt;
					document.getElemntById("txnid").value=Discount;
					document.getElemntById("txnid").value=PayAmt;
					document.getElemntById("txnid").value=totalAmt; */
