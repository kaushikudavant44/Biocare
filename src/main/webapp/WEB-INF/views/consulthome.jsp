...
<!-- Carousel================================================== -->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item active"> <img class="first-slide" src="${pageContext.request.contextPath}/resources/images/consult-banner.jpg" alt="health care"></div>
   </div>
<!-- /.carousel --> 
</div>
...
<!--signup over-->
<div class="clearfix"></div>
 <section class="lab_testsec consult_sec">
	<div class="container">
	<div class="row">
	<div class="col-sm-10">
		<h2>Talk to a doctor from anywhere</h2>
		 <ul class="list_doc">
					<li>Call and Chat privately with a verified doctor</li>
					<li>Get a response in 5 minutes!</li>
		</ul>
		<hr>
		<h2>Online consult through</h2>
		<ul class="radio_list">
		<c:choose>
<c:when test="${sessionScope.patientDetails.patientId>0}">
		<%-- <a href="${pageContext.request.contextPath}/showBookAppointment" class="btn-fr-all">Find Right Lab</a> --%>
		<li>Video Calling <a href="${pageContext.request.contextPath}/showBookAppointment"> <img src="${pageContext.request.contextPath}/resources/images/video_i.png" class="img-responsive" alt="video call"></a></li>
			<%-- <li>Chat <a href="#"><img src="${pageContext.request.contextPath}/resources/images/chat_i.png" class="img-responsive" alt="chat"></a></li> --%>
			<li>Audio Calling <a href="${pageContext.request.contextPath}/showBookAppointment"><img src="${pageContext.request.contextPath}/resources/images/call_i.png" class="img-responsive" alt="call"></a></li>
...
<c:otherwise>
		...
		<li>Video Calling <a href="#" onclick="openLoginModal(5)"> <img src="${pageContext.request.contextPath}/resources/images/video_i.png" class="img-responsive" alt="video call"></a></li>
			<li>Audio Calling <a href="#" onclick="openLoginModal(5)"><img src="${pageContext.request.contextPath}/resources/images/call_i.png" class="img-responsive" alt="call"></a></li>
