...
<div class="login_screen"><%-- <img src="${pageContext.request.contextPath}/resources/images/login_bg.png" class="img-responsive" alt="login"> --%>
<img src="${pageContext.request.contextPath}/resources/images/lablogin1.jpg" class="img-responsive" alt="login">
</div>
