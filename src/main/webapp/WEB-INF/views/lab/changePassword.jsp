...
<script type="text/javascript">
  ...
  <c:url var="labPasswordValidation" value="labPasswordValidation" />
<c:url var="changeLabPassword" value="changeLabPassword" />	
 ...
 <section class="log_sec">
	...
	<div class="container">
	 <div class="login1_blk">
		...
		<a href="${pageContext.request.contextPath}/showLabHomePage">Cancel</a>
	 </div>
