...
<c:url var="saveLabDetailsAndPayment"
		value="/saveLabDetailsAndPayment" />
    ...
    <h3 class="text-center">Failed</h3>
   	<p>Sorry Lab Payment Is Failed</p>
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
							<a class="proceed_b" href="${pageContext.request.contextPath}/showLabLoginPage">Exit</a>
						</div>
					</div>
...
<div class="success-blk " id="successDiv" style="display: none">
 ...
 <h3 class="text-center">Thank You</h3>
	<p>Your Lab Payment Completed Successfully</p>
	<div class="row">
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					<%-- <div class="col-xs-6 col-sm-6 col-md-6 pad-0">
						<div class="receipt-right">
							<a class="exit_b" href="${pageContext.request.contextPath}/showLabLoginPage">Exit</a>
						</div>
					</div> --%>
					<div class="col-xs-12 col-sm-12 col-md-12 pad-0">
						<div class="text-center">
						<a class="proceed_b" href="${pageContext.request.contextPath}/showEditLabProfile">Proceed</a>
						</div>
					</div>
				</div>
            </div>
            ...
            <div>
				...
				<!-- <div class="row">
					<div class="receipt-header receipt-header-mid receipt-footer">
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="receipt-left">
							<a class="proceed_b" href="#">Proceed</a>
							</div>
						</div>
					</div>
	            </div>  -->
	...
	<%-- <%=outputHTML%> --%>
		...
		<a id="urlBtn" style="display: none" href="${pageContext.request.contextPath}/showLabLoginPage">Go To Login</a>
