...
<div class="container-fluid">
 ...
 <jsp:include page="../include/labLeftMenu.jsp"/>
	 ...
	 <div class="login1_blk">
	 	...
	 	<form action="verifyRegisterOTP" method="post">
	 	 <p>OTP is sent on your registered mobile number -<br> xxxxxx${mobileNumber}</p>  
	 	 	<a   href="javascript:verifyMobileNumber(${labDetails.contact})"  >Generate OTP</a>
        <input type="text" id="otp" name="otp" placeholder="Enter One Time Password" class="capitl_none"   required="required" >
	 	...
	 	<form action="searchUserNameForLabForgotPassword" id="resendOtp" method="post">
...
function verifyMobileNumber(contactNo){
