		...
		<div class="bhoechie-tab-container">
			<div class="drop-content">
				<div class="row">
					...
					<c:forEach items="${labNotificationList}"
						var="labNotificationList">
						<c:choose>
						<c:when test="${labNotificationList.status==0}">
						<div class="col-md-12 col-sm-12 col-xs-12 pd-l0 border-bottom unread-bg">
							<div class="all-notofication">
								...
								<p class="dr-icon">${labNotificationList.string1}</p>
 								<p>${labNotificationList.notification}.</p>
								<p class="date">${labNotificationList.dateTime}"</p>
							</div>
						</div>
						</c:when>
						<c:otherwise>
