...
<c:url var="getLabReportReceiptHistory" value="/getLabReportReceiptHistory" />
                ...
                <div class="bhoechie-tab-content active">
 					 ...
 					 <div class="filter_div doc_fil">
 					 	...
 					 	<div class="row">
							 ...
							 <div class="col-md-4 col-sm-4">
							 <input type="button" class="btn-fr-all" onclick="getConsultReceiptHistory()" Value="Search"/> 
							 </div>
						</div>
 					 </div>
 		<div class="clearfix"></div>
...
function getConsultReceiptHistory()
{
	...
	var toDate=document.getElementById("toDate").value;
	  ...
	  $('#consultingReceiptHistory td').remove();
					$.getJSON('${getLabReportReceiptHistory}', {
				 ...
				 var totalAmt=0;
						...
						tr.append($('<td></td>').html('<a href="${pageContext.request.contextPath}/pdfViewReportReceipt/'+list.receiptNo+'">View Receipt</a>'));
