			...
			<div class="bhoechie-tab-container">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab">
					<div class="bhoechie-tab-content active">
						<form method="POST" action='${pageContext.request.contextPath}/updateLabProfilesProcess' id="reset">
							<div class="row editpg">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input required type="text" class="input-text" value="${contactNo}" name="contact" id="contactNo"  onblur="verifyNum();" 
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="exampleInputEmail1">City</label> <select
											required class="input-text chosen-select" id="cityId"
											name="cityId" >
								...
								<div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                  	<div class="form-group">
										<label for="exampleInputEmail1">Lab From-Time</label> <input
											required type="text" class="input-text"
											value="${fromTime}" name="fromTime" id="fromTime" placeholder="AM"/>
									</div>
								...
								<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Lab To-Time</label> <input
											required type="text" class="input-text"
											value="${toTime}" name="toTime" id="toTime" placeholder="PM"/>
									</div>
								</div>
								<div class="col-sm-12">
