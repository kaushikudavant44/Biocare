...
public class DoctorDetails {
	...
	public String toString() {
		return "DoctorDetails [doctorId=" + doctorId + ", userName=" + userName + ", password=" + password + ", fName="
				+ fName + ", lName=" + lName + ", refferalCode=" + refferalCode + ", mName=" + mName + ", gender="
				+ gender + ", cityId=" + cityId + ", stateId=" + stateId + ", countryId=" + countryId + ", address="
				...
				+ ", college=" + college + ", passingYear=" + passingYear + ", specId=" + specId + ", hospitalId="
				+ hospitalId + ", councilRegNo=" + councilRegNo + ", councilName=" + councilName + ", delStatus="
				+ delStatus + ", string1=" + string1 + ", string2=" + string2 + ", int1=" + int1 + ", int2=" + int2
				+ ", fees=" + fees + ", signature=" + signature + ", webToken=" + webToken + "]";
	}
